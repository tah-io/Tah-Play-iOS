...
- (void)commonInit
{
	_backgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Joy Back"]];
	...
	_handleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Joy Handle"]];
	CGRect handleImageFrame = [_handleImageView frame];
	handleImageFrame.size = CGSizeMake([_backgroundImageView bounds].size.width /3.0,
									   [_backgroundImageView bounds].size.height /3.0);
