...
- (void)viewDidLoad
{
    ...
    arrayofImages = [[NSArray alloc]initWithObjects:@"frame.png",@"frame.png",@"frame.png",@"frame.png",@"frame.png",@"frame.png",nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        PSViewController *detailViewController = [segue destinationViewController];
    ...
    else if ([[segue identifier] isEqualToString:@"Cell2"])
    {
        ...
        detailViewController.title = @"Play Station";
